...
class MCP9808:
    ...
    def __init__(self, i2c_address=0X18, i2c_bus=3, round_digits=1):
    ...
    def single_access_read(self, reg=0x00):
        ...
        dataTransfer=self.bus.read_byte_data(self.i2c_address, reg)
    ...
    def single_word_read(self, reg=0x00):
        ...
        dataTransfer=self.bus.read_word_data(self.i2c_address, reg)
    ...
    def single_access_write(self, reg=0x00, regValue = 0):
        ...
        self.bus.write_byte_data(self.i2c_address, reg, regValue)
    ...
    def single_word_write(self, reg=0x00, regValue = 0):
        ...
        self.bus.write_word_data(self.i2c_address, reg, regValue)
    ...
    def read_temperature(self):
        ...
        return round(temperature, self.round_digits)
